    ...
    **SEE ALSO**
    ...
    def drawRect(self, layer = None, color = Color.DEFAULT, width = 1, alpha = 128):
        ...
        **EXAMPLE**
        ...
        layer.rectangle(self.topLeftCorner(), (self.width(), self.height()), color, width, filled = width < 1, alpha = alpha)
    ...
    def drawAppx(self, color = Color.HOTPINK, width = -1 , alpha = -1, layer = None):
        ...
        layer.polygon(self.mContourAppx, color, width, width < 1, True, alpha)
    ...
    def isSquare(self, tolerance = 0.05, ratiotolerance = 0.05):
        ...
        **EXAMPLE**
        ...
        """
        return self.isRectangle(tolerance) and abs(1 - self.aspectRatio()) < ratiotolerance
    ...
    def getMatchMetric(self, otherBlob):
        ...
        # chunk of our points.
        tmean = sps.tmean(distances, (mindist, x + sd))
